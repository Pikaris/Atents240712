...
namespace _01_Console
{
    ...
    // 복사 방식 : 깊은 복사(완전한 사본을 만드는 것), 얕은 복사(주소만 넘겨주는 것)
    
    // 참조타입(Reference type) : 얕은 복사. 복사속도가 빠르다. 실체는 1개만 있다(원본이던 카피본이던 하나를 변경하면 둘다 변경된다.)
    // 값타입(Value type) : 깊은 복사. 복사속도는 느리다. 실체가 복사한 만큼 생긴다.


    // static : 정적, 프로그램이 실행되기 전에 메모리 위치가 결정되어 있는 것. 
    ...
    public class TestClass
    {
        ...
        private int value1;     // private : 나만 사용할 수 있다.(클래스 안에서만 사용 가능)
        ...
        void Test()
        {
            ...
            b = 20;
            //ArrayList array = new ArrayList();  //절대 사용하지 말것
            //array.Add(10);
            //array.Add(10.5f);
            //array.Add("Hello");
        }
    ...
    internal class Program
    {
        ...
        static void kukudan(int num)
        {
            ...
            foreach (int i in kukuArray)
            {
                kukuResult = num * (i + 1);
                Console.WriteLine($"{num} x {i + 1} = {kukuResult}");
            }
        ...
        static void Main(string[] args)
        {
            ...
            // 반복문
            //int count = 0;
            //while (count < 3)       // while : ()사이의 조건이 참이면 반복해서 {}안의 내용을 실행
            //{
            ...
            //Console.WriteLine("저는 정석환입니다. 나이는 XX입니다.");
            //int age = 10;
            //Console.WriteLine("저는 정석환입니다. 나이는 " + age + "살입니다.");   // 절대절대절대 비추천, 메모리를 너무 차지함
            //Console.WriteLine($"저는 정석환입니다. 나이는 {age}살입니다.");      // 합칠 때는 이런 방식으로 처리. 쌍따옴표앞에 $붙이고 변수는 {} 사이에 넣는다.
            ...
            //// C#에는 크게 나눠서 2가지 타입이 있다. 값 타입, 참조 타입
            //// 값타입(Value type) : 스택 메모리에 저장, int, float, bool, 기타 구조체(struct)
            //// 참조타입(Reference type) : 힙 메모리에 저장, string, 기타 클래스(class)
            ...
            //// 2. 점수를 입력 받아서 90점 이상이면 A, 80점 이상이면 B, 70점 이상이면 C, 60점 이상이면 D, 60점 미만이면 F를 주기
            ...
            //Console.Write("나이를 입력하세요 : ");
            //string? ageString = Console.ReadLine();
            ////int age1 = int.Parse(ageString)
            //Console.Write("주소를 입력하세요 : ");
            //string? adress1 = Console.ReadLine();
            //Console.WriteLine($"저는 {adress1}에 사는 {name1}({ageString})입니다.");
            ...
            // 논리연산자 : &&(and, 연산자의 오른쪽과 왼쪽이 모두 true일 때만 true), ||(or, 둘중 하나만 true면 true), 항상 결과는 true 아니면 false.               ///
            //              true  && true;  // true                                                                                                                /// 
            //              true  && false; // false                                                                                                               /// 
            //              false && true;  // false                                                                                                               /// 
            //              false && false; // false                                                                                                               /// 
            ...
            //              false || true;  // true                                                                                                                ///
            //              false || false; // false                                                                                                               /// 
            // 비트연산자 : &(and, 오른쪽에 있는 비트와 왼쪽에 있는 비트가 모두 1일때 1), |(or, 오른쪽에 있는 비트와 오른쪽에 있는 비트가 하나만 1이면 1)          ///
            //              int a = 123;                                                                                                                           ///
            ...
            //// F10 : 현재 멈춰있는 지점에서 다음 행으로 넘어가기

            //// 편집용 단축키
            //// Ctrl + D : 현재 코드를 한줄 복사해서 붙여넣기
            //// Shift + Del : 현재 줄 지우기
            //// Ctrl + 좌우 화살표 : 단어 단위로 이동하기
            //// Ctrl + 위아래 화살표 : 커서 위치는 그대로 두고 페이지를 위아래로 움직이기

            //Console.WriteLine("Hello, World! 안녕!");
            //Console.WriteLine("Hello, World! 너는!");
            //Console.WriteLine("Hello, World! 잘 지내니!");
            //Console.WriteLine("Hello, World! 괜찮아!");
            ...
            //// 데이터 타입 :  변수의 종류
            ////  정수(Integer) : int, 소수점이 없는 숫자(0, 10, -25 등등) 가장 기본적 32bit
            ...
            //a = 2100000000;
            ////a = 4100000000;     // 사이즈를 넘어가면 실행 안됨
            ////a = 21.5f;          // 데이터 타입이 다르면 안됨

            //// = 대입 연산자, == 비교 연산자
            //float b = 20.1234561111111111111111111111111f; // 뒤에 f는 필수, 32bit
            //double b2 = 20.123456789123456789123456789;  // 64bit
            ...
            //                    // 문자열 비교는 컴퓨터 처리가 많아진다. 문자열 비교는 죄악, 범죄
